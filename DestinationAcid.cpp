...
//Constructor
DestinationAcid::DestinationAcid() {


}

//Constructor
DestinationAcid::DestinationAcid(int x, int y, SDL_Renderer* gRenderer, string path) {
...
void DestinationAcid::Move() {

	//Containers are static on the map

}

void DestinationAcid::Render(SDL_Renderer* gRenderer) {
